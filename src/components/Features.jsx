...
function Features() {
  ...
  return (
    ...
    // The inline style has been removed from the section tag below.
    <section id="features" className="section">
      <div ref={ref} className={`features-container ${isVisible ? 'is-visible' : ''}`}>
        ...
        <div className="features-grid">
          <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5} glareEnable={true} glareMaxOpacity={0.1} glarePosition="all" onMouseMove={(e) => handleMouseMove(e, e.currentTarget)}>
